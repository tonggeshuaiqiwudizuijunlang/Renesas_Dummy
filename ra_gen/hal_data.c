...
#if (1 == 1)
transfer_info_t wifi_dtc_transfer_info DTC_TRANSFER_INFO_ALIGNMENT =
{
...
transfer_info_t wifi_dtc_transfer_info[1] DTC_TRANSFER_INFO_ALIGNMENT;
#else
/* User must call api::reconfigure before enable DTC transfer. */
#endif

const dtc_extended_cfg_t wifi_dtc_transfer_cfg_extend =
{
    .activation_source   = VECTOR_NUMBER_SCI6_TXI,
};

const transfer_cfg_t wifi_dtc_transfer_cfg =
{
#if (1 == 1)
    .p_info              = &wifi_dtc_transfer_info,
#elif (1 > 1)
    .p_info              = wifi_dtc_transfer_info,
#else
    .p_info = NULL,
#endif
    .p_extend            = &wifi_dtc_transfer_cfg_extend,
};

/* Instance structure to use this module. */
const transfer_instance_t wifi_dtc_transfer =
{
    .p_ctrl        = &wifi_dtc_transfer_ctrl,
    .p_cfg         = &wifi_dtc_transfer_cfg,
...
#define RA_NOT_DEFINED (1)
#if (RA_NOT_DEFINED == wifi_dtc_transfer)
                .p_transfer_tx       = NULL,
#else
                .p_transfer_tx       = &wifi_dtc_transfer,
#endif
#if (RA_NOT_DEFINED == RA_NOT_DEFINED)
                .p_transfer_rx       = NULL,
#else
...
#if (1 == 1)
transfer_info_t sbus_dtc_transfer_info DTC_TRANSFER_INFO_ALIGNMENT =
{
    .transfer_settings_word_b.dest_addr_mode = TRANSFER_ADDR_MODE_INCREMENTED,
    .transfer_settings_word_b.repeat_area    = TRANSFER_REPEAT_AREA_DESTINATION,
    .transfer_settings_word_b.irq            = TRANSFER_IRQ_END,
...
#elif (1 > 1)
/* User is responsible to initialize the array. */
transfer_info_t sbus_dtc_transfer_info[1] DTC_TRANSFER_INFO_ALIGNMENT;
#else
/* User must call api::reconfigure before enable DTC transfer. */
#endif

const dtc_extended_cfg_t sbus_dtc_transfer_cfg_extend =
{
    .activation_source   = VECTOR_NUMBER_SCI9_RXI,
};

const transfer_cfg_t sbus_dtc_transfer_cfg =
{
#if (1 == 1)
    .p_info              = &sbus_dtc_transfer_info,
#elif (1 > 1)
    .p_info              = sbus_dtc_transfer_info,
#else
    .p_info = NULL,
#endif
    .p_extend            = &sbus_dtc_transfer_cfg_extend,
};

/* Instance structure to use this module. */
const transfer_instance_t sbus_dtc_transfer =
{
    .p_ctrl        = &sbus_dtc_transfer_ctrl,
    .p_cfg         = &sbus_dtc_transfer_cfg,
    .p_api         = &g_transfer_on_dtc
};
sci_uart_instance_ctrl_t     sbus_ctrl;

            baud_setting_t               sbus_baud_setting =
            {
                /* Baud rate calculated with 0.806% error. */ .semr_baudrate_bits_b.abcse = 0, .semr_baudrate_bits_b.abcs = 0, .semr_baudrate_bits_b.bgdm = 1, .cks = 0, .brr = 61, .mddr = (uint8_t) 256, .semr_baudrate_bits_b.brme = false
            };

            /** UART extended configuration for UARTonSCI HAL driver */
            const sci_uart_extended_cfg_t sbus_cfg_extend =
            {
                .clock                = SCI_UART_CLOCK_INT,
                .rx_edge_start          = SCI_UART_START_BIT_FALLING_EDGE,
                .noise_cancel         = SCI_UART_NOISE_CANCELLATION_DISABLE,
                .rx_fifo_trigger        = SCI_UART_RX_FIFO_TRIGGER_MAX,
                .p_baud_setting         = &sbus_baud_setting,
                .flow_control           = SCI_UART_FLOW_CONTROL_RTS,
                #if 0xFF != 0xFF
                .flow_control_pin       = BSP_IO_PORT_FF_PIN_0xFF,
                #else
...
#define RA_NOT_DEFINED (1)
                ...
                .p_transfer_tx       = &RA_NOT_DEFINED,
#endif
#if (RA_NOT_DEFINED == sbus_dtc_transfer)
                .p_transfer_rx       = NULL,
#else
                .p_transfer_rx       = &sbus_dtc_transfer,
#endif
#undef RA_NOT_DEFINED
                .rxi_ipl             = (4),
                .txi_ipl             = (12),
